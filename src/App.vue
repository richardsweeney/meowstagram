...
<template>
    ...
    >
        <h1 class="text-2xl bold flex gap-2 items-center">
            <svg
            ...
            <RouterLink to="/">Meowstagram</RouterLink>
        </h1>
        ...
        <div class="hidden md:flex gap-4">
            <RouterLink
                ...
                :key="link.to"
                :to="link.to"
                class="underline-offset-5 hover:underline"
        ...
        >
            <div class="overflow-hidden">
                <div
                    class="bg-linear-to-r from-sunset-yellow to-sunset-coral text-gray-900 shadow-xl flex flex-col p-8 gap-4"
                >
                    <RouterLink
                        v-for="link in menuLinks"
                        :key="link.to"
    ...
    <div class="p-4 lg:p-8 mx-auto max-w-2xl pb-32">
        <RouterView />
    </div>
</template>
